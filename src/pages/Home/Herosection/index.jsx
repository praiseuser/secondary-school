      ...
      <Box sx={{ position: 'relative', height: '100vh', minHeight: 640, overflow: 'hidden' }}>
        ...
        <Box
          sx={{
            ...
            background: `linear-gradient(105deg, ${colors.primary.dark}EE 0%, ${colors.primary.dark}99 30%, ${colors.primary.main}55 60%, ${colors.primary.dark}CC 100%)`,
          }}
        />
        ...
        <Typography
          sx={{
            position: 'absolute',
            right: { xs: '-10%', md: '2%' }, bottom: '-5%',
            fontFamily: typography.fontFamily.accent,
            fontSize: { xs: '18rem', md: '24rem' },
            fontWeight: typography.fontWeight.black,
            color: colors.primary.light, opacity: 0.06,
        ...
        >
          <Box sx={{ maxWidth: { xs: '100%', md: 580 } }}>
            ...
            >
              ...
              <Typography sx={{ fontFamily: typography.fontFamily.body, fontSize: typography.fontSize.xs, fontWeight: typography.fontWeight.semiBold, color: colors.secondary.light, letterSpacing: 2.5, textTransform: 'uppercase' }}>
                {slides[current].tag}
              </Typography>
            </Box>
            ...
            <Box
              key={`line-${animKey}`}
              sx={{ height: 3, bgcolor: colors.secondary.main, mb: 3, borderRadius: 2, animation: 'expandWidth 0.6s ease 0.5s both' }}
            />
            ...
            <Typography
              ...
              sx={{
                ...
                lineHeight: 1.85, mb: 4.5, maxWidth: 460,
        ...
        {/* Progress bar */}
        <Box sx={{ position: 'absolute', bottom: 0, left: 0, right: 0, height: 3, bgcolor: 'rgba(255,255,255,0.1)', zIndex: 5 }}>
          <Box
            key={`progress-${animKey}`}
            sx={{ height: '100%', bgcolor: colors.secondary.main, animation: 'expandWidth 8s linear both', width: '100%' }}
          />
        </Box>

        {/* Slide dots */}
        <Stack
          direction="row" gap={1.2} alignItems="center"
          sx={{
            position: 'absolute',
            bottom: 28,
            left: { xs: '50%', md: 'auto' },
        ...
        <Box sx={{ position: 'absolute', bottom: 26, left: { xs: 20, md: 80 }, zIndex: 5 }}>
          <Typography sx={{ fontFamily: typography.fontFamily.body, fontSize: typography.fontSize.xs, color: 'rgba(255,255,255,0.35)', letterSpacing: 3 }}>
